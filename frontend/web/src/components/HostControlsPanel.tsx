            ...
            {activeTab === 'participants' && (
                <div className="host-controls-participants">
                    <div className="host-actions-bar">
                        ...
                        <button
                            className={`btn-lock ${settings.locked ? 'active' : ''}`}
                            onClick={() => onLockMeeting(!settings.locked)}
                        >
                        ...
                        {participants.map((p) => (
                            <li key={p.peerId} className="host-participant-item">
                                ...
                                <div className="host-participant-actions">
                                    ...
                                    <select
                                        value={p.role}
                                        onChange={(e) => onChangeRole(p.peerId, e.target.value)}
                ...
                <div className="host-controls-settings">
                    ...
                    <label className="setting-toggle">
                        ...
                        <input
                            ...
                            onChange={(e) => onUpdateSettings({ muteOnEntry: e.target.checked })}
                        />
                    </label>
                    <label className="setting-toggle">
                    ...
                    {!confirmEnd ? (
                        ...
                        <div className="end-confirm">
                            ...
                            <button className="btn-end-confirm" onClick={onEndMeeting}>
                                Yes, End Meeting
                            </button>
                            <button className="btn-end-cancel" onClick={() => setConfirmEnd(false)}>
                                Cancel
                            </button>
                        </div>
                    )}
